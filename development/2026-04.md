...
- **typing**: Phase 2 mobile — typing indicators (dark launch) (#882)
- **settings**: friendly dialog when active Plus user taps Redeem Code (#881)
- **mobile**: Dot party-hat easter egg (Phase 2) (#869)

### 🐛 Bug Fixes
- **unread**: exclude user's own messages from unread counts (#757)
...
### ✨ Features
- **api**: add 'achievements' notification preference with data-only fallback (#729)
